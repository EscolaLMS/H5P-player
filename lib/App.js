...
function App() {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "App" }, { children: (0, jsx_runtime_1.jsxs)(index_1.EditorContextProvider, __assign({ url: "https://escola-lms-api.stage.etd24.pl/api/hh5p" }, { children: [state.state === "editor" ? ((0, jsx_runtime_1.jsx)(index_2.default, { id: state.id, onSubmit: function (response) {
