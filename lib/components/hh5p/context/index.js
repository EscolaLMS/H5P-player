...
var EditorContextProvider = function (_a) {
    ...
    var _b = (0, react_1.useState)({ value: "initial" }), state = _b[0], setState = _b[1];
    var headers = (0, react_1.useMemo)(function () {
        return new Headers({
    ...
    return ((0, jsx_runtime_1.jsx)(exports.EditorContext.Provider, __assign({ value: { url: url, state: state, getEditorConfig: getEditorConfig, getContentConfig: getContentConfig, submitContent: submitContent } }, { children: children }), void 0));
};
