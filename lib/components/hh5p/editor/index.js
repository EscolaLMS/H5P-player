...
var Editor = function (_a) {
    ...
    var _c = (0, react_1.useState)({
        state: "initial",
    }), editorState = _c[0], setEditorState = _c[1];
    var _d = (0, react_1.useContext)(context_1.EditorContext), state = _d.state, getEditorConfig = _d.getEditorConfig, submitContent = _d.submitContent;
    ...
    var src = (0, react_1.useMemo)(function () {
        ...
        var markup = (0, server_1.renderToStaticMarkup)((0, jsx_runtime_1.jsxs)("html", { children: [(0, jsx_runtime_1.jsxs)("head", { children: [(0, jsx_runtime_1.jsx)("style", { children: " body, html {margin:0; padding:0;}" }, void 0), (0, jsx_runtime_1.jsx)("script", { dangerouslySetInnerHTML: {
                                __html: "const H5PIntegration = window.H5PIntegration = " + JSON.stringify(settings) + "; ",
                            } }, void 0), settings.core.scripts.map(function (script) { return ((0, jsx_runtime_1.jsx)("script", { src: script }, script)); }), settings.core.styles.map(function (style) { return ((0, jsx_runtime_1.jsx)("link", { type: "text/css", rel: "stylesheet", href: style }, style)); })] }, void 0), (0, jsx_runtime_1.jsx)("body", { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor-wrapper" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ id: "h5p-editor", className: "height-observer" }, { children: "loading" }), void 0), (0, jsx_runtime_1.jsx)("p", {}, void 0), (0, jsx_runtime_1.jsx)("button", __assign({ className: "h5p-core-button", id: "h5p-editor-submit" }, { children: "submit data" }), void 0), (0, jsx_runtime_1.jsx)("script", { dangerouslySetInnerHTML: { __html: scriptInline } }, void 0)] }), void 0) }, void 0)] }, void 0));
        var pMarkup = prepareMarkupForPassing(markup);
        return window.URL.createObjectURL(new Blob([pMarkup], {
            type: "text/html",
        }));
    }, [state]);
    return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "h5p-editor", style: { height: height, position: "relative" } }, { children: [editorState.state === "loading" && (0, jsx_runtime_1.jsx)(loader_1.default, {}, void 0), editorState.state === "error" && ((0, jsx_runtime_1.jsxs)("p", { children: [(0, jsx_runtime_1.jsx)("pre", { children: "Error:" }, void 0), " ", editorState.error] }, void 0)), src && ((0, jsx_runtime_1.jsx)("iframe", { ref: iFrameRef, title: "editor", src: src, style: {
                    width: "100%",
                    height: "100%",
                    margin: 0,
                    padding: 0,
