...
var Editor = function (_a) {
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "h5p-editor", style: { height: height, position: "relative" } }, { children: [editorState.state === "loading" && jsx_runtime_1.jsx(loader_1.default, {}, void 0),
            ...
            src && (jsx_runtime_1.jsx("iframe", { ref: iFrameRef, title: "editor", src: src, style: {
                    width: "100%",
                    height: "100%",
                    margin: 0,
                    padding: 0,
