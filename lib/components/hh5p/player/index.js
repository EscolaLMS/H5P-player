...
var Player = function (_a) {
    var id = _a.id, onXAPI = _a.onXAPI, _b = _a.styles, styles = _b === void 0 ? [] : _b;
    var _c = react_1.useState(100), height = _c[0], setHeight = _c[1];
    var iFrameRef = react_1.useRef(null);
    var _d = react_1.useState(true), loading = _d[0], setLoading = _d[1];
    var _e = react_1.useContext(context_1.EditorContext), state = _e.state, getContentConfig = _e.getContentConfig;
    ...
    var src = react_1.useMemo(function () {
        ...
        var markup = server_1.renderToStaticMarkup(jsx_runtime_1.jsxs("html", { children: [jsx_runtime_1.jsxs("head", { children: [jsx_runtime_1.jsx("style", { children: "\n          body, html {margin:0; padding:0;}\n          iframe { border:none; margin:0; padding:0; }\n          " }, void 0),
                ...
                jsx_runtime_1.jsx("body", { children: jsx_runtime_1.jsxs("div", __assign({ className: "h5p-player-wrapper h5p-resize-observer" }, { children: [(embedType && embedType === "div") ||
                                (embedType === "" && (jsx_runtime_1.jsx("div", { className: "h5p-content", "data-content-id": id }, void 0))),
    ...
    return (jsx_runtime_1.jsxs("div", __assign({ className: "h5p-player", style: { height: height } }, { children: [loading && jsx_runtime_1.jsx(loader_1.default, {}, void 0),
            jsx_runtime_1.jsx("iframe", { ref: iFrameRef, title: "player", src: src, style: {
                    display: "block",
                    width: "100%",
                    border: "none",
                    height: "100%",
